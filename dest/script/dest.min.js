...
function GETSYSTEMCONFIG(a){"use strict";switch(a){case"local":return{type:"local",URL1:"http://snsdev.midea.com/",URL2:"http://snsdev.midea.com/",URL3:"http://snsdev.midea.com/",userID:"1izXGn700Hf%2F6U%2BYg8rwxA2tpBP36LpZal28Epy9zc9vaGRy39AkvQ%3D%3D",debug:!0,alertDebug:!1};case"dev":return{type:"dev",basicURL:"http://snsdev.midea.com/",userID:"",debug:!1,alertDebug:!0};case"beta":return{type:"beta",basicURL:"http://snsdev.midea.com/",userID:"",debug:!1,alertDebug:!1};case"pro":return{type:"pro",basicURL:"http://sns.midea.com/",userID:"",debug:!1,alertDebug:!1};default:alert("[System Info] ## config error! ##")}}function GETTIME(){var a=new Date,b=a.getHours()>9?a.getHours():"0"+a.getHours(),c=a.getMinutes()>9?a.getMinutes():"0"+a.getMinutes(),d=a.getSeconds()>9?a.getSeconds():"0"+a.getSeconds(),e=a.getMilliseconds();return b+":"+c+":"+d+":"+e}function DEBUG(a,b){var c=b?b:"SYSTEM";SYSTEMCONFIG.alertDebug===!0?alert("System time : "+GETTIME()+"\nMethod name : "+c+"\n"+JSON.stringify(a)):SYSTEMCONFIG.debug===!0&&(console.log("System time : "+GETTIME()+"\nMethod name : "+c),console.log(a),console.log("#######################################"),console.log(""))}var SYSTEMCONFIG=GETSYSTEMCONFIG("local");DEBUG(SYSTEMCONFIG,"System Config Setting");var CORDOVAUSER="",CORDOVAPHONE={initialize:function(){this.bindEvents()},bindEvents:function(){document.addEventListener("deviceready",this.onDeviceReady,!1)},onDeviceReady:function(){CORDOVAPHONE.hideNav(),CORDOVAPHONE.hideBackButton(),CORDOVAPHONE.getUser(),CORDOVAPHONE.initCamera()},hideNav:function(){cordova.exec(function(a){},function(a){},"MideaCommon","hideNav",[])},getUser:function(){cordova.exec(function(a){CORDOVAUSER=a.uid,DEBUG(CORDOVAUSER,"Cordova Get UserInfo success")},function(a){DEBUG(a,"Cordova Get UserInfo error")},"MideaUser","getUser",[])},hideBackButton:function(){cordova.exec(function(a){DEBUG(CORDOVAUSER,"Cordova hideBackButton success")},function(a){DEBUG(CORDOVAUSER,"Cordova hideBackButton error")},"MideaCommon","hideFloat",[])},callUp:function(a){cordova.exec(function(a){},function(a){},"MideaCommon","callPhone",[a])},exit:function(){cordova.exec(function(a){},function(a){},"MideaCommon","exit",[])}};CORDOVAPHONE.initialize();var app=angular.module("midea",["ionic","LocalStorageModule"]);app.config(["$stateProvider","$urlRouterProvider","$ionicConfigProvider","localStorageServiceProvider",function(a,b,c,d){"use strict";c.tabs.position("bottom"),c.tabs.style("standard"),d.setPrefix("midea"),a.state("index",{url:"/index",templateUrl:"script/modules/index/index.html",controller:"IndexCtrl"}).state("page",{url:"/page",templateUrl:"script/modules/page/page.html",controller:"PageCtrl"}),b.otherwise("/index")}]),function(){"use strict";var a=function(a,b,c){a.screenWidth=document.documentElement.clientWidth,a.screenHeight=document.documentElement.clientHeight,a.goURL=function(a,c){b.go(a+"",c)},c.init()};a.$inject=["$rootScope","$state","Application"],app.controller("MainCtrl",a)}(),function(){"use strict";var a=function(a){return{restrict:"EA",replace:!1,transclude:!0,scope:!0,template:'<ion-item ng-click="goBack()" class="nav-bar-button"><i class="ion-chevron-left color-white"></i></ion-item>',link:function(b){b.goBack=function(){a.history.back()}}}};a.$inject=["$window"],app.directive("historyBack",a)}(),function(){"use strict";var a=function(a){return{restrict:"EA",replace:!1,transclude:!0,scope:{txt:"=txt"},controller:["$scope",function(a){this.setValue=function(b){a.txt=b}}],controllerAs:"indexCtrl",template:'<div class="w-100p mt-10"><label>表格directive示例</label><label>txt按钮：<input type="text" ng-model="txt" class="bg-gray" /></label><div>输入字符：{{txt}}</div><div ng-click="show()">Directive Txt 的值</div><div ng-click="showCtrl()">IndexCtrl Txt 的值</div></div>',link:function(a,b,c,d){a.txt="Directive txt",a.show=function(){DEBUG(a.txt)},a.showCtrl=function(){d.setValue("23"),a.$emit("changeTxt","")}}}};a.$inject=["$window"],app.directive("myDirective",a)}(),function(){"use strict";var a=function(a){DEBUG("IndexCtrl"),a.txt="IndexCtrl txt",a.$on("changeTxt",function(){DEBUG(a.txt)})};a.$inject=["$scope"],app.controller("IndexCtrl",a)}(),function(){"use strict";var a=function(){DEBUG("PageCtrl")};a.$inject=[],app.controller("PageCtrl",a)}(),function(){"use strict";var a=function(){var a={init:function(){DEBUG("Service is ok")}};return a};a.$inject=[],app.factory("Application",a)}(),function(){"use strict";var a="/mobileterminalaction.do",b=function(b,c){var d={httpGet:function(d){var e=c.defer();return b.get(SYSTEMCONFIG.basicURL+a,{params:d}).success(function(a){DEBUG(a,d.method+" Success"),e.resolve(a)}).error(function(a){DEBUG(a,d.method+" Error"),e.reject(a)}),e.promise}};return d};b.$inject=["$http","$q"],app.factory("Postman",b)}(),function(){"use strict";var a=function(a){var b={init:function(){DEBUG("Storage is ok")},setStorage:function(b,c){a.set(b,c)},getStorage:function(b){return a.get(b)},removeStorage:function(b){return a.remove(b)},clearStorage:function(){return a.clearAll()},getLocalStorageItem:function(b,c){var d=a.get(b,c)||"";return""!==d?JSON.parse(d):null}};return b};a.$inject=["localStorageService"],app.factory("Storage",a)}();